...
*/
    ...
    for (var row = 2; row <= lastRow; row++){
        ...
        var memberInfo = updateSheet.getSheetValues(row, 1, 1, lastCol); // 入力情報をを行列として取得

        if (memberInfo[0][0] !== "") {continue;} // A列に何か文字が入力されている場合はそこで処理終了
